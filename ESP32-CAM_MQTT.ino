/*
 *El envío de imagen por mqtt esta basado en el siguiente codigo
 *se realizaron cambios en la configuración de Wi-Fi y del servidor MQTT
ESP32-CAM MQTT
...
const char* ssid = "Netsaul";
const char* password = "12345678";


const char* mqtt_server = "200.79.180.228";
...
String feedback = "";
//Menu de ejecución, espera comando desde el topic públicado en mqtt
void executeCommand() {
  //Serial.println("");
...
//Envia la imagen tomada por el ESPCAM por MQTT
String sendImage() {
  camera_fb_t * fb = NULL;
